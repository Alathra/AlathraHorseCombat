...
public abstract class FileUtils {
    ...
    public static void extractResource(
        ...
        try (
            InputStream stream = AlathraHorseCombat.getInstance().getResource(resourcePath.toString().replace('\\', '/'))
        ) {
            if (stream == null)
    ...
    public static Set<String> resourceListFiles(
        ...
        final URL url = AlathraHorseCombat.getInstance().getClass().getResource("");
